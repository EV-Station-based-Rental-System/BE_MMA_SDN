...
import { ApiOkResponse, ApiBadRequestResponse, ApiBearerAuth, ApiBody, ApiConflictResponse, ApiCreatedResponse, ApiForbiddenResponse, ApiInternalServerErrorResponse, ApiOperation, ApiQuery, ApiUnauthorizedResponse, ApiNotFoundResponse } from '@nestjs/swagger';
