...
import { StatusBooking, VerficationStatus } from 'src/common/enums/statusBooking.enum';
...
export class Booking {
  ...
  @Prop({ required: true, enum: VerficationStatus, default: VerficationStatus.PENDING })
